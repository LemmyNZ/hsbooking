# Generated by Django 2.2.6 on 2019-11-09 00:47
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pet_type', models.CharField(default='Dog', max_length=10)),
                ...
                ('vaccine', models.CharField(choices=[('rabies', 'Rabies'), ('Bordtella', 'Bordtella'), ('Canine Distemper / Parvo Combo', 'Canine Distemper / Parvo Combo'), ('Canine Influenza', 'Canine Influenza'), ('Leptospirosis (Lepto4)', 'Leptospirosis (Lepto4)'), ('Canine C3', 'Canine C3'), ('Canine C4', 'Canine C4'), ('Canine C5', 'Canine C5'), ('Canine C7', 'Canine C7'), ('Feline FVRCP group (rhino, calic, distemper)', 'Feline FVRCP group (rhino, calic, distemper)'), ('Feline Herpesvirus (FHV)', 'Feline Herpesvirus (FHV)'), ('Feline Calicivirus (FCV)', 'Feline Calicivirus (FCV)'), ('Feline Panleukopenia (FPK)', 'Feline Panleukopenia (FPK)')], max_length=40)),
                ...
                ('diabetic', models.BooleanField(verbose_name='Anal Gland Issues')),
